...
unsigned long amd64_cpuid_supported(void)
{
  /* Nothing to do in the simulator. */
	return (1);
}

void amd64_cpuid_insn(unsigned long i, void * r)
{
  /* Nothing to do in the simulator. */
}

void amd64_rdmsr(unsigned long i, unsigned long long * p)
{
  /* Nothing to do in the simulator. */
}

void amd64_wrmsr(unsigned long i, const unsigned long long * p)
{
  /* Nothing to do in the simulator. */
}
